...
@Composable
fun CluePage2(navController: NavController, timerState: TimerState) {
    ...
    val locationPermissionRequest = rememberLauncherForActivityResult(
        ...
        onResult = { permissions ->
            if (permissions[Manifest.permission.ACCESS_FINE_LOCATION] == true ||
                ...
                //Log.d("DEBUG", "Location permissions denied")
    ...
    Column(
        ...
        Text(
            text = stringResource(R.string.clue2),
            fontSize = 24.sp,
        ...
        if (showHint) {
            Text(
                text = stringResource(R.string.hint2),
                fontSize = 24.sp,
                textAlign = TextAlign.Center,
                modifier = Modifier.padding(bottom = 16.dp)
            )
        ...
        Button(
            onClick = {
                //Log.d ("DEBUG", "Location not available yet, requesting fresh location...")
                isLoading = true
                fetchCurrentLocation(
                    context,
                    fusedLocationClient,
                ...
                if(userLocation!!.latitude != null) {
                    ...
                    if (isNearLocation(
                            ...
                            44.5595, -123.2814, .005
                        )
                    ) {
                        //Log.d("DEBUG", "User is within range! Navigating to treasureHuntCompletedPage")
                        navController.navigate("treasureHuntCompletedPage")
                    } else {
